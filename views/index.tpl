...
<body>
        ...
        <div class="card d-flex justify-content-center align-items-center" style="width: 100%;height: 100%;border-top-color: rgb(129,199,132);border-right-style: none;border-bottom-color: rgb(129,199,132);border-left-style: none;">
            <div class="card-body d-flex flex-column justify-content-center align-items-center" style="height: 634px;border-style: none;border-bottom-color: #81c784;border-left-style: none;">
                ...
                <div class="row d-flex flex-grow-0"
                    ...
                    <div class="col-12 col-sm-12 col-lg-5 offset-0 d-flex justify-content-center align-items-center align-content-center" style="padding-right: 0px;padding-left: 0px;"><input type="text" style="height: 100%;margin: 0px;width: 100%;text-align: center;background: rgba(222,222,222,0.5);padding: 18px;border-style: none;border-left-style: solid;" placeholder="CODE POSTAL"></div>
                    <div class="col-5 col-sm-12 col-lg-5"
                        style="padding: 0px;padding-left: 0px;"><select class="d-flex justify-content-center align-items-center" style="height: 100%;width: 100%;margin: 0px;margin-top: 0px;margin-right: 0px;text-align: center;background: rgba(222,222,222,0.5);border-style: none;border-left-style: solid;padding: 18px;"><optgroup label="This is a group"><option value="12" selected="">This is item 1</option><option value="13">This is item 2</option><option value="14">This is item 3</option></optgroup></select></div>
                    <div
    ...
    <div class="shadow-none highlight-phone" style="margin-top: 35px;margin-right: 35px;margin-left: 35px;margin-bottom: 35px;background: rgba(129,199,132,0);">
        <div class="container">
            <div class="row d-flex flex-row justify-content-center align-items-center" style="margin-top: 25px;margin-bottom: 30;padding: 0px;padding-bottom: 30px;">
