...
<body>
    <div class="container-fluid d-flex flex-column justify-content-center align-items-center"
        style="padding-right: 30px;padding-left: 30px;margin: 0px;padding-bottom: 30px;padding-top: 30px;height: 97vh;width: 100%;text-shadow: 0px 0px;">
        <div class="card d-flex justify-content-center align-items-center"
            style="width: 100%;height: 100%;border-top-color: rgb(129,199,132);border-right-style: none;border-bottom-color: rgb(129,199,132);border-left-style: none;">
            <div class="card-body d-flex flex-column justify-content-center align-items-center"
                style="height: 500px;border-style: none;border-bottom-color: #81c784;border-left-style: none;">
                <h1 style="color: #009432; font-size:8rem;">Fragil'Indice</h1>
                <h1 style="color: #81c784;">Calculez rapidement votre indice de fragilité numérique !</h1>
                <p
                    style="margin: 46px;text-align: center;width: 70%;margin-left: 30px;margin-right: 30px;margin-top: 30px;margin-bottom: 30px; text-align: justify;">
                    Cet indice permet d’identifier les zones les plus touchées par une exclusion numérique et par
                    l’illectronisme (contraction d’illettrisme et d’électronique).<br>
                    La construction de l’indice repose sur de nombreuses études qualitatives et quantitatives. Le labo
                    inclusion numérique de l’ANSA identifie 4 conditions liées à la probabilité d’avoir accès aux
                    services dont au moins une partie du processus nécessite un usage numérique :
                </p>
                <ul style="list-style-type:circle;  margin-bottom: 5%;" class="d-flex flex-row  list-group row">
                ...
                <div class="row d-flex flex-grow-0" style="width: 95%;height: 85px;">
                    <div class="col-12 col-sm-12 col-lg-5 offset-0 d-flex justify-content-center align-items-center align-content-center"
                ...
                <div class="row d-flex flex-grow-0" style="width: 95%;height: 85px;">
                    <div class="col-12 col-sm-12 col-lg-5 offset-0 d-flex justify-content-center align-items-center align-content-center"
                        style="padding-right: 0px;padding-left: 0px;">
                        <input id="txt_code_postal" type="number"
                            style="height: 100%;margin: 0px;width: 100%;text-align: center;background: rgb(222,222,222);padding: 18px;border-style: none;border-left-style: solid;"
                            placeholder="CODE POSTAL"></div>
                    <div class="col-5 col-sm-12 col-lg-5" style="padding: 0px;padding-left: 0px;">
                        <select id="communes" disabled="true"
                    ...
                    <div class="d-none d-md-block phone-mockup">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p id='idGlobalScore' class="text-left card-text"
                                    style="text-align: center;font-size: 18px;">/100</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="shadow-none highlight-phone"
        ...
        <div class="container">
            ...
            <div class="row d-flex flex-row justify-content-between align-items-center" style="margin-top: 49px;">
                ...
                <div class="col-md-12 col-lg-3 d-flex justify-content-center align-items-center"
                    style="box-shadow: 0px 0px;">
                    <div class="card  border shadow-lg" style="padding: 10px;">
                        <div class="card-body" style="color: #e61611;">
                            <h6 class=" card-subtitle mb-2" style="text-align: center;color: #EE5A24;">Accès aux
                                interfaces numériques</h6>
                            <p id='idAccesInferfaceNumeriqueScore' class="card-text"
                                style="text-align: center;font-size: 90px;color: #EE5A24;">35</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-3 d-flex justify-content-between align-items-center"
                    style="box-shadow: 0px 0px;">
                    <div class="card  border  shadow-lg" style="width: 100%;height: 100%;margin: 10px;padding: 10px;">
                        <div class="card-body">
