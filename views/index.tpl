...
<body>
    <div class="container-fluid" style="padding-bottom: 30px;padding-top: 30px;text-shadow: 0px 0px;">
        <div class="card" style="text-align:center; border-top-color: #81c784;border-right-style: none;border-bottom-color: #81c784;border-left-style: none;">
            <div class="card-body d-flex flex-column align-items-center intro" style=" border-style: none;border-bottom-color: #81c784;border-left-style: none;">
                <h2 style="color: #81c784; width: 100%; ">Fragil'Indice</h2>
                ...
                <div class="row" style="width: 95%; margin-top:10px; margin-bottom: 5px;">
    ...
    <div class="shadow highlight-phone align-items-center">
        <div class="container" >
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="card text-center border-secondary border rounded-circle shadow-lg" style="border-style: none; height: 225px; width: 225px;">
                                        <div class="card-body">
                                            <h5 class="text-muted">Score départemental</h5>
                                            <h6 id='idNomDepartement' class="text-muted"></h6>
                                            <p id='idDepartementalScore' class="card-text" style="font-size: 90px;"></p>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="card text-center border-secondary border rounded-circle shadow-lg" style="border-style: none;">
                                        <div class="card-body">
                                            <h5 class="text-muted">Score départemental</h5>
                                            <h6 id='idNomDepartement' class="text-muted"></h6>
                                            <p id='idDepartementalScore' class="card-text" style="font-size: 90px;"></p>
                ...
                <div class="col-md-12 col-lg-3 d-flex justify-content-center align-items-center"
                    ...
                    <div class="card border-secondary border rounded-circle shadow-lg" style="padding: 10px;">
                        <div class="card-body" style="color: #e61611;">
                            ...
                            <p  id='idAccesInferfaceNumeriqueScore' class="card-text" style="text-align: center;font-size: 90px;color: #e61611;"></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-3 d-flex justify-content-center align-items-center"
                    ...
                    <div class="card border-success border rounded-circle shadow-lg"
                        ...
                        <div class="card-body">
                            ...
                            <p id='idAccesInformationScore' class="card-text"
                                style="font-size: 90px;text-align: center;color: #92d36f;"></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-warning border rounded-circle shadow-lg"
                        ...
                        <div class="card-body">
                            ...
                            <p id='idCompetencesNumeriqueScore' class="card-text"
                                style="font-size: 90px;text-align: center;color: #f4eb49;"></p>
                        </div>
                    </div>
                </div>
            </div>
